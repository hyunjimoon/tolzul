...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| Fixed Planning with Belief Inference<br>(answering how)                        | [[📍focusing on action sample ratio]]<br>[[📝🧭Vectorizing Adaptation]]<br>[[🎲Sampling with and without Replacement]]<br>                       | [[📝🪶Sequential Evolutionary and Parallel Bayesian Startup Adaptations]] |
