...
| $\textcolor{green}{S}$                                                         | Stakeholder acceptance state (binary)                                                             | $\textcolor{green}{S} = [0, 1, 0]$: ops partner has said yes, but customer and investor are unconvinced            | [[III.🤜👥Expectation Propagation to Lower Operational Multi-Stakeholder Complexities]] |
| $\textcolor{#3399FF}{U_d}, \textcolor{#3399FF}{U_s}, \textcolor{#3399FF}{U_i}$ | Residual uncertainties for each stakeholder                                                       | High $\textcolor{#3399FF}{U_s}$ if testing is pending; lower $\textcolor{#3399FF}{U_d}$ if builders are supportive | [[III.🤜👥Expectation Propagation to Lower Operational Multi-Stakeholder Complexities]] |
| $\textcolor{purple}{W_d}, \textcolor{purple}{W_s}, \textcolor{purple}{W_i}$    | Stakeholder weights                                                                               | Sublime may prioritize $\textcolor{purple}{W_s}$ over $\textcolor{purple}{W_d}$ early on                           | [[III.🤜👥Expectation Propagation to Lower Operational Multi-Stakeholder Complexities]] |
| $B$                                                                            | Maps $\textcolor{green}{S}$ to $\textcolor{#3399FF}{U}$                                           | Even if customer likes the cement, lack of ASTM validation keeps $\textcolor{#3399FF}{U_s}$ high                   | [[II.🧐👥Proactive Testing to Lower Multi-stakeholder Complexity]]                      |
...
| $D$                                                                            | Transition function: $\textcolor{green}{S}, \textcolor{red}{A} \rightarrow \textcolor{green}{S'}$ | Applying to testing lab may unlock investor confidence indirectly                                                  | [[II.🧐👥Proactive Testing to Lower Multi-stakeholder Complexity]]                      |
