...
| $B$                                                                            | Maps $\textcolor{green}{S}$ to $\textcolor{#3399FF}{U}$                                           | Even if customer likes the cement, lack of ASTM validation keeps $\textcolor{#3399FF}{U_s}$ high                   | [[II.🔄Multi-Stakeholder Decision Matrices]]                      |
...
| $D$                                                                            | Transition function: $\textcolor{green}{S}, \textcolor{red}{A} \rightarrow \textcolor{green}{S'}$ | Applying to testing lab may unlock investor confidence indirectly                                                  | [[II.🔄Multi-Stakeholder Decision Matrices]]                      |
