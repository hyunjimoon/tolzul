...
| ------------------------------------------------------------------------------ | ----------------------- | ---------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------ | ----------------------------- | --------------------------------- |
| **1. Introduction – Set the Stage by Bridging Industry and Knowledge (10)**    |                         |            | [[1p1(📜🪢)]]                     | [[🗄️(p1c(nso)s(so)(📜🪢))]]<br>introduces how <br>                                                          | x                             | [[search(llm, lp1lc012ls12)]]     |
|                                                                                | 1.1 Phenomenon          | 4          | [[1phenomenon(📜🪢, p1)]]         |                                                                                                              | x                             |                                   |
|                                                                                | 1.2 Need–Solution Pair  | 3          | [[1need-solution(📜🪢, p1)]]      | and [[🗄️compare(🪢, cs_co)]] compares the spectrum of too theoretical and practical (with 🪢 in the middle) | x                             |                                   |
...
|                                                                                | 3.1 Key Findings        | 3          |                                   |                                                                                                              |                               | 06-09 [[🧲classify(move, cases)]] |
...
| -------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| **P5**   | **Nature of the Need – A Two‑Stage Sequencing Problem**         | Early‑stage ventures must (i) design a value proposition that shapes stakeholder acceptance probabilities and then (ii) decide **when** and **whom** to approach under resource limits. We formulate this as two stage decision making under uncertainty, given the perishable nature of probability and cost ratio in entrepreneurial environment |                                                                                                                         |
| **P6**   | **Short‑Sighted Heuristics: Effectuation’s Underspecification** | Path‑dependent heuristics (left column of the comparison table) provide actionability but treat acceptance probabilities and cost asymmetries as black boxes, offering little guidance when intuition misfires and leading to systematic over‑ or under‑investment.                                                                                | [[📜CS_Sarasvathy01(caus_eff)]] effectuation disaggregates time and test statistics too much                            |
| **P7**   | **Over‑Engineered Analytics: The Fully‑Integrated Ideal**       | At the other extreme, exhaustive optimisation frameworks assume full information and unlimited modelling capacity; their elegance collapses in nascent markets where **Cu, Co, pr** are unobservable or unstable, leaving founders without implementable direction.                                                                                | [[📜SS_stern24_model(beliefs, experimentation)]] Bayesian entrepreneurship aggregates time and test statistics too much |
| **P8**   | **Gap: A Pragmatic–Normative Middle Ground**                    | The divergence between these two streams reveals a void for frameworks that are both mathematically coherent **and** practically deployable – a role the STRAP model (middle column) fills by turning acceptance into measurable binary states and prescribing parameter regions rather than point estimates.                                      | [[🗄️compare(🪢, cs_co)]]                                                                                               |
| **P9**   | **Operational Logic: Newsvendor‑Style Critical Ratios**         | STRAP reframes sequencing as an inventory‑style decision: entrepreneurs weigh the ‘overage’ cost of idle resources against the ‘underage’ cost of unmet demand, yielding a critical‑ratio threshold that dictates whether to court resource partners or customers first and when to pivot.                                                         | [[📜SO_johnston02]]                                                                                                     |
