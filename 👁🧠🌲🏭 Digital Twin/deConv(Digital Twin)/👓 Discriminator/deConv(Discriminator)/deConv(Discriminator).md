...
Architecturally, it would be the inverse of Generator: [[def(Program)]], [[def(Program)]], [[def(Science)]] based on how in GAN discriminator neural networks are constructed inversely to generator.
