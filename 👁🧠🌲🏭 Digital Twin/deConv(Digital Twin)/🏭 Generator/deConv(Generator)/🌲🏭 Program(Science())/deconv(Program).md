...
- [Probabilistic method](https://en.wikipedia.org/wiki/Probabilistic_method) is a nonconstructive method in that it uses P(A) > 0 to prove the existence of A. This is weak yes from [[def(Discriminator)]]. 
