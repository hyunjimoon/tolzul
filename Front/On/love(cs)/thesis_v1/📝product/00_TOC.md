...
modified:
  ...
  - 2025-11-19T10:03:30-05:00
  - 2025-11-22T06:24:39-05:00
---
![[00_TOC 2025_11_19.excalidraw]]


[[2025-11-19]]에서 이상은 pivoting cost가 높은 하드웨어 산업에서 더 많은 옵션을 가지고 있어야하는데, 투자들의 인식 (조기 커밋)때뭉네 t2c1할 자금을 얻지 못하거나 울며겨자먹기로 premature scaling을 함
...
|  4  | **04_EmpiricalMethodology**         | 약속 모호성(V), 유연성(F) 등 주요 변수의 측정 방법을 정의하고, 내생성 문제 해결을 위한 식별 전략과 분석 모형(OLS, Logit)을 설정하며 강건성 검증 계획을 제시합니다. | 권준                     | -                                             | 🗄️T_DescStats, 🗄️T_MainSpecs                                                 |
