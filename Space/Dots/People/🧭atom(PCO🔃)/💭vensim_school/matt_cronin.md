...
- for [[ns(operations and innovation management for early-stage social scientists)]], which focuses on education (unlike [[🔄UTB_understanding-theory-body]]), using SD model for scientific knowledge production , [[Space/Sources/Papers/📜Cronin21_synthesize(theory)]], [[enterprise - matt_Takeaways.txt]], [[enterprise - matt.txt]]
