...
pw_tt = piecewiseVariables(TRAIN_TT ,thresholds)
...
def utilPW(tt):
    piecewise_cost = piecewiseVariables(tt,thresholds)
    betas = ['B_TRAIN_TIME1','B_TRAIN_TIME2','B_TRAIN_TIME3','B_TRAIN_TIME4']
    betaValues = results_M2.getBetaValues(betas)
    V = betaValues['B_TRAIN_TIME1'] * piecewise_cost[0].getValue() / 100 + betaValues['B_TRAIN_TIME2'] * piecewise_cost[1].getValue() / 100 + betaValues['B_TRAIN_TIME3'] * piecewise_cost[2].getValue() / 100  + betaValues['B_TRAIN_TIME4'] * piecewise_cost[3].getValue() / 100
    return V
