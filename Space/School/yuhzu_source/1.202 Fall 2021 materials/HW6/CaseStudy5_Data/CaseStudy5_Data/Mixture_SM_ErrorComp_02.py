...
CLASSIC_mean = Beta('CLASSIC',0,-10,10,1)
CLASSIC_std = Beta('CLASSIC_std',0,-10,10,0)
RAIL_mean = Beta('RAIL',0,-10,10,1)
...
# Utilities
V_Car_SP = ASC_CAR * one + BETA_TIME * CAR_TT/100 + BETA_COST * CAR_CO/100 + CLASSIC_random * one
V_SBB_SP = ASC_SBB * one + BETA_TIME * TRAIN_TT/100 + BETA_COST * TRAIN_COST/100 + BETA_HE * TRAIN_HE/100 + RAIL_random * one + CLASSIC_random * one
