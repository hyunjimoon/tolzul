...
#Utilities
V_BM = ASC_BM * one + B_MCOST * cost1
V_SM = ASC_SM * one + B_MCOST * cost2
V_LF = ASC_LF * one + B_FCOST * cost3 + B_USERS * users
V_EF = ASC_EF * one + B_FCOST * cost4 + B_USERS * users
V_MF = ASC_MF * one + B_FCOST * cost5 + B_USERS * users
