...
#Utilities
V_BM = ASC_BM * one + B_COST * cost1
V_SM = ASC_SM * one + B_COST * cost2
V_LF = ASC_LF * one + B_COST * cost3 + B_USERS * users
V_EF = ASC_EF * one + B_COST * cost4 + B_USERS * users
V_MF = ASC_MF * one + B_COST * cost5 + B_USERS * users
