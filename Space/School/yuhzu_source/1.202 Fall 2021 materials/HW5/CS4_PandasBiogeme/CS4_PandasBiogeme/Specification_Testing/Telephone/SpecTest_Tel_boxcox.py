...
LAMBDA   = Beta('LAMBDA',0.00003,-10,10,0)
...
#Utilities
V_BM = ASC_BM * one + B_MCOST * (cost1**LAMBDA-1)/LAMBDA
V_SM = ASC_SM * one + B_MCOST * (cost2**LAMBDA-1)/LAMBDA
...
biogeme.modelName = "SpecTest_Tel_boxcox"
