...
TRAIN_TT1  = DefineVariable('TRAIN_TT1',pw_tt[0], database)
TRAIN_TT2  = DefineVariable('TRAIN_TT2',pw_tt[1], database)
TRAIN_TT3  = DefineVariable('TRAIN_TT3',pw_tt[2], database)
TRAIN_TT4  = DefineVariable('TRAIN_TT4',pw_tt[3], database)
