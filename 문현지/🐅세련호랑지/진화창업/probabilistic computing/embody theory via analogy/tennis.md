...
# 🎾 BEAM Tennis System - Simple Version
*Updated: 2025-01-27*

## 🏸 Quick Visual Guide (Player's View)
...
<svg viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 🐢 FEET (Bottom - where player stands) -->
  <g id="turtle">
  ...
  <!-- 🐙 ARMS (Service Line Right - Flexible Control) -->
  <g id="octopus">
...
낭만거북이 의(🐢), 세련호랑이 지(🐅), 절절문어 용(🐙), 똘똘외계인 현(👾)의 특성을 테니스 기술에 체화시킨 전략적 프레임워크
...
#### 🎯 암기 구호: **"Track and Attack"** (추적하고 공격)
